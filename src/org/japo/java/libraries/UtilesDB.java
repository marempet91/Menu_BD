...
public class UtilesDB {
    ...
    private static final String DEF_CONS_MYSQL = String.format(DEF_FORM_MYSQL,
            DEF_PROT_MYSQL, DEF_HOST_MYSQL,
            DEF_PORT_MYSQL, DEF_DBAM_MYSQL,
            DEF_USER_MYSQL, DEF_PASS_MYSQL);
    ...
    public static final Connection obtenerConexion(String prot, String host, String port, String db, String user, String pass) throws SQLException {
        String cadenaConexion = String.format(DEF_FORM_MYSQL, port, host, port, db, user, pass);
        return obtenerConexion(cadenaConexion);
    }
